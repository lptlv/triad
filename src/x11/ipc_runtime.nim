...
proc xlibreCommandSupported(msg: Msg): bool =
  ...
  of MsgKind.CmdCloseWindow, MsgKind.CmdCloseWindowById, MsgKind.CmdFocusNext,
      ...
      MsgKind.CmdFocusColumnFirst, MsgKind.CmdFocusColumnLast, MsgKind.CmdFocusTag,
      MsgKind.CmdFocusWorkspaceIndex, MsgKind.CmdFocusWindowById,
      MsgKind.CmdMoveToTagLeft, MsgKind.CmdMoveToTagRight, MsgKind.CmdMoveToTag,
      MsgKind.CmdSwapWindowToTag, MsgKind.CmdMoveToWorkspaceIndex,
      MsgKind.CmdMoveWindowToWorkspaceIndex, MsgKind.CmdSwitchLayout,
      MsgKind.CmdMaximizeColumn, MsgKind.CmdToggleFullscreen,
      MsgKind.CmdToggleMaximized, MsgKind.CmdMinimize, MsgKind.CmdMoveWindowLeft,
      MsgKind.CmdMoveWindowRight, MsgKind.CmdMoveWindowUp, MsgKind.CmdMoveWindowDown,
      MsgKind.CmdMoveColumnLeft, MsgKind.CmdMoveColumnRight,
