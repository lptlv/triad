...
proc runXlibreSuites() =
  ...
  exec "nim c -r --hints:off --nimcache:tests/nimcache tests/tx11_ipc_writable.nim"
...
task tidy, "Remove local Nim build outputs and project cache artifacts":
  for path in [
    ...
    "tests/tx11-probe-smoke-close-key-client.log", "tests/tx11-probe-smoke-config.kdl",
    "tests/tx11-probe-smoke-focus-next-a-client.log",
    "tests/tx11-probe-smoke-focus-next-b-client.log",
    ...
    "tests/tx11-probe-smoke-key-press.log",
    "tests/tx11-probe-smoke-shifted-key-press.log",
    "tests/tx11-probe-smoke-close-key-press.log",
    "tests/tx11-probe-smoke-focus-next-press.log",
    "tests/tx11-probe-smoke-maximize-column-press.log",
    "tests/tx11-probe-smoke-maximize-edges-press.log",
    "tests/tx11-probe-smoke-fullscreen-press.log",
    "tests/tx11-probe-smoke-layout-scroller-press.log",
    "tests/tx11-probe-smoke-vertical-scroller-press.log",
    "tests/tx11-probe-smoke-switch-layout-press.log",
    ...
    "tests/tx11-probe-smoke-mapping-notify.log",
    "tests/tx11-probe-smoke-xkb-state.log",
